...
web application/stitch/projects/416028161469279318/screens/414557ac3f244f9586563574345b2aa1

\# Design-System Dokumentation: Athletic Intel (Blue Design)



\## 1. Visuelle Identität \& Markencharakter

Das Design-System „Athletic Intel“ ist für professionelle Fußballtrainer konzipiert. Es verbindet eine \*\*sportlich-dynamische Ästhetik\*\* mit der \*\*Präzision eines Daten-Dashboards\*\*. Der Look ist modern, clean und orientiert sich am Next.js/shadcn-Ökosystem.



\## 2. Farbschema (Theming)

Das Farbschema nutzt eine neutrale Basis mit einem kräftigen Blau als primäre Akzentfarbe, um Fokus und Professionalität zu vermitteln.



\*   \*\*Primärfarbe (Action):\*\* Professionelles Blau (`#3B82F6`). Wird für Call-to-Actions, aktive Navigationszustände und primäre Daten-Highlights verwendet.

\*   \*\*Hintergrund:\*\* Sehr helles Grau/Blau (`#F9FAFB`) für die Arbeitsfläche, um einen hohen Kontrast zu den Inhalten zu gewährleisten.

\*   \*\*Oberflächen (Cards):\*\* Reines Weiß (`#FFFFFF`) mit subtilen, einpixeligen Rahmen (`#E2E8F0`) und minimalen Schatten, um Tiefe ohne visuelles Rauschen zu erzeugen.

\*   \*\*Textfarben:\*\*

&#x20;   \*   \*Primary:\* Tiefes Anthrazit (`#111827`) für maximale Lesbarkeit.

&#x20;   \*   \*Secondary:\* Mittleres Grau (`#6B7280`) für Metadaten und erklärende Texte.

\*   \*\*Status-Indikatoren:\*\*

&#x20;   \*   Erfolg/Fit: Emerald Green

&#x20;   \*   Warnung/Reha: Amber/Orange

&#x20;   \*   Fehler/Verletzt: Rose/Red



\## 3. Typografie

\*   \*\*Schriftart:\*\* Lexend (optimiert für schnelle Lesbarkeit von Daten und Zahlen).

\*   \*\*Hierarchie:\*\* Klare Unterscheidung durch Schriftschnitte (Semi-Bold für Headlines, Regular für Body).

\*   \*\*Zahlen:\*\* Fokus auf Tabellarische Ziffern für eine bessere Vergleichbarkeit in Statistiken.



\## 4. Komponenten-Stil (shadcn-basiert)

\*   \*\*Buttons:\*\* Klare Kanten mit minimalem Border-Radius (8px). Primäre Buttons sind vollflächig blau, sekundäre Buttons nutzen Outline-Stile.

\*   \*\*Cards:\*\* Modulare Container mit konsistentem Padding (24px). Trennung von Header, Content und Footer durch subtile Linien.

\*   \*\*Inputs/Filter:\*\* Minimalistische Felder mit Fokus-Ringen in der Primärfarbe.

\*   \*\*Daten-Visualisierung:\*\* Nutzung von Fortschrittsbalken, Radar-Charts und Kreisdiagrammen in Blau-Nuancen.



\## 5. Mobile-First Prinzip

Obwohl die Desktop-Ansicht für detaillierte Analysen optimiert ist, basiert das gesamte Layout auf einem \*\*flexiblen Grid-System\*\*. Alle Karten und Tabellen sind so konzipiert, dass sie auf mobilen Endgeräten nahtlos untereinander gestapelt werden können, um dem Trainer am Spielfeldrand die bestmögliche UX zu bieten.
