...
export function DeleteFeedbackButton({ feedbackId }: { feedbackId: string }) {
  return (
    ...
    >
      ...
      <button className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-danger-soft px-4 text-sm font-semibold text-danger transition hover:bg-danger-soft" type="submit">
